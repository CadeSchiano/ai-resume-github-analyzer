  ...
  return (
    <main className={styles.page}>
      ...
      <article className={styles.content}>
        ...
        <h2>Optional AI explanations</h2><p>If you choose “Add an AI explanation,” DevProof sends the completed report to OpenAI to generate an explanation. It does not send the raw PDF file. This request is configured not to be stored by the application’s OpenAI API request. Do not select this option if you do not want the completed report used to create an AI explanation.</p>
