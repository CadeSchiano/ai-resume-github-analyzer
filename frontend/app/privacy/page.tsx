...
export const metadata: Metadata = {
  title: "Privacy Policy | Repolume",
  description: "How Repolume handles resume uploads, public GitHub data, and optional AI explanations.",
};

export default function PrivacyPage() {
  return (
    <main className={styles.page}>
      <nav className={styles.nav}><a className={`wordmark ${styles.wordmark}`} href="/"><span>repolume</span><i>developer readiness</i></a><a href="/">Back to Repolume</a></nav>
      <article className={styles.content}>
        <p className="eyebrow">PRIVACY POLICY</p>
        <h1>Clear about the data used for your analysis.</h1>
        <p className={styles.lede}>Effective September 8, 2026. This policy explains how Repolume handles information submitted through this beta application.</p>
        <h2>Information used to provide the service</h2><p>Repolume receives the GitHub username, PDF resume, selected target role, and AI-explanation preference that you submit. It uses these inputs to generate your developer-readiness report.</p>
        <h2>Public GitHub information</h2><p>Repolume analyzes repositories and related information that are publicly available through GitHub’s API. It does not access private repositories.</p>
        <h2>Resume processing and retention</h2><p>Your resume is processed during the request to extract text and generate the report. Repolume’s application code does not save resumes or extracted resume text to a database or other persistent application storage after processing.</p>
