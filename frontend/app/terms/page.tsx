...
export const metadata: Metadata = {
  title: "Terms of Use | Repolume",
  description: "Terms of use for the Repolume developer-readiness beta.",
};
  ...
  return (
    <main className={styles.page}>
      ...
      <article className={styles.content}>
        ...
        <h1>Use Repolume thoughtfully.</h1>
        <p className={styles.lede}>Effective September 8, 2026. These terms govern use of the Repolume beta.</p>
        <h2>Beta service</h2><p>Repolume is an experimental developer-readiness tool. Features, availability, and the analysis may change as the beta develops.</p>
