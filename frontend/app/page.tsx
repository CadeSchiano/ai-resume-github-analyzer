...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="site-footer"><span>DevProof beta</span><div><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="mailto:cade73328@gmail.com">Contact</a></div></footer>
    </main>
  );
}
